...
public function dashboard()
{
    ...
    $reviews = Review::with('customer')->where('vendor_id', $vendorId)->latest()->get();
    
    // Average rating
    $averageRating = Review::where('vendor_id', $vendorId)->avg('rating');
    
    return view('vendor.dashboard', compact('orderCount', 'productCount', 'totalSales', 'reviews', 'averageRating'));
